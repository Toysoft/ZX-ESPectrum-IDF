...
const Mode VGA::MON_SAFE_4_3(8, 48, 24, 320, 11, 2, 31, 480, 2, 12587500, 1, 1, 41,84,7,7,0,0,6,6);  // 31469 / 60.05
const Mode VGA::MON_SAFE_16_9(8, 54, 28, 360, 11, 2, 32, 400, 2, 14161000, 1, 0, 44,84,7,6,0,0,6,5);  // 31469 / 70.72

const Mode VGA::MON_50_4_3(8, 48, 24, 320, 16, 3, 48, 720, 3, 15746659, 1, 1, 205,5,7,5,0,0,7,5);  // 39367 / 50.02
const Mode VGA::MON_50_16_9(8, 54, 28, 360, 31, 3, 33, 600, 3, 15013849, 1, 1, 214,2,8,6,0,0,5,4);  // 33364 / 50.02

const Mode VGA::TV_50_4_3(42, 32, 62, 320, 28, 3, 40, 240, 1, 7093800, 1, 1, 107,238,5,12,0,0,8,15);  // 15557 / 50.02
const Mode VGA::TV_50_16_9(22, 32, 42, 360, 48, 3, 60, 200, 1, 7093800, 1, 1, 107,238,5,12,0,0,8,15);  // 15557 / 50.02

// Not used: 48K 312p modes
