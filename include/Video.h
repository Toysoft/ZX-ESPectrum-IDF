...
// EXPERIMENTAL 352x264 
#define TS_SCREEN_320x240 6248  // START OF VISIBLE ULA DRAW 48K @ 320x240, SCANLINE 28, -24 FROM BORDER
#define TS_SCREEN_320x240_128 6130  // START OF VISIBLE ULA DRAW 48K @ 320x240, SCANLINE 27, -24 FROM BORDER
